    ...
    <>
      ...
      <div className="relative overflow-hidden min-h-[420px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full py-20 sm:py-28">
          <p className="font-inter text-[14px] uppercase tracking-[0.22em] text-gold-400 mb-5">Contact</p>
          <h1
          ...
          <div className="grid lg:grid-cols-3 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:sticky lg:top-24 space-y-5">
              ...
              <div className="bg-ink rounded-3xl p-7 text-cream">
                <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-gold-400 mb-3">Direct Email</p>
                <p className="font-display font-bold text-lg mb-3" style={{ letterSpacing: '-0.012em' }}>
                  Rather send an email?
                </p>
                <a
                  href="mailto:info@myafrowaka.com"
                  className="flex items-center gap-2 font-inter text-[14px] uppercase tracking-[0.14em] text-gold-400 hover:text-gold-300 transition-colors break-all"
                >
                  info@myafrowaka.com
              ...
              <div className="bg-sand dark-flip-surf rounded-3xl p-7 border border-line dark-flip-border">
                <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-charcoal/40 dark-flip-muted mb-4">What to Expect</p>
                <ul className="space-y-5">
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-display font-semibold text-[14px] text-charcoal dark-flip-text">Response time</p>
                      <p className="font-sans text-[14px] text-charcoal/55 dark-flip-muted mt-0.5">Within 2 business days</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-xl bg-cream dark-flip-card border border-line dark-flip-border flex items-center justify-center shrink-0">
                    ...
                    <div>
                      <p className="font-display font-semibold text-[14px] text-charcoal dark-flip-text">Based in</p>
                      <p className="font-sans text-[14px] text-charcoal/55 dark-flip-muted mt-0.5">Abuja, Nigeria</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-xl bg-cream dark-flip-card border border-line dark-flip-border flex items-center justify-center shrink-0">
                    ...
                    <div>
                      <p className="font-display font-semibold text-[14px] text-charcoal dark-flip-text">Coverage</p>
                      <p className="font-sans text-[14px] text-charcoal/55 dark-flip-muted mt-0.5">Pan-African editorial team</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="border border-line dark-flip-border rounded-3xl p-7">
                <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-charcoal/40 dark-flip-muted mb-5">For Faster Replies</p>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <span className="font-inter text-[14px] text-gold-500 mt-1 shrink-0">0{i + 1}</span>
                      <p className="font-sans text-[14px] text-charcoal/60 dark-flip-muted leading-relaxed">{tip}</p>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="bg-cream dark-flip-card border border-line dark-flip-border rounded-3xl p-6">
                <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-charcoal/40 dark-flip-muted mb-4">Find Us</p>
                <div className="space-y-2">
                  {[
                    ...
                    <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                      ...
                      <span className="font-inter text-[14px] text-charcoal/35 dark-flip-muted group-hover:text-crimson transition-colors">{s.handle}</span>
                    </a>
                  ))}
                </div>
              </div>
              ...
              <Link href="/about"
                ...
                <div>
                  <p className="font-inter text-[14px] uppercase tracking-[0.18em] text-charcoal/35 dark-flip-muted mb-1">Learn more</p>
