      ...
      <div className="relative overflow-hidden min-h-[480px] flex items-end">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full pb-12 pt-24">
          ...
          {locationParts.length > 0 && (
            <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-gold-400 mb-4">
              {locationParts.join(' · ')}
            </p>
          )}
          ...
          <div className="grid lg:grid-cols-3 gap-10 lg:gap-14 items-start">
            ...
            <div className="lg:col-span-2 min-w-0">
              ...
              <div className="lg:hidden bg-ink rounded-3xl p-6 text-cream mb-8">
                <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-gold-400 mb-5">At a Glance</p>
                <div className="space-y-0">
                  {a.country && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Country</span>
                      <span className="font-sans text-[14px] text-cream/88 text-right">{a.country.name}</span>
                    </div>
                  )}
                  {a.continentRegion && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Region</span>
                      <span className="font-sans text-[14px] text-cream/88 text-right">{a.continentRegion}</span>
                    </div>
                  )}
                  {a.type && a.type.length > 0 && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Type</span>
                  ...
                  {a.city && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Nearest City</span>
                      <span className="font-sans text-[14px] text-cream/88 text-right">{a.city.name}</span>
                    </div>
                  )}
                  {a.nearestAirportIATA && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Airport</span>
                  ...
                  {a.heritageEra && a.heritageEra.length > 0 && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Era</span>
                  ...
                  {a.suitableFor && a.suitableFor.length > 0 && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Suitable For</span>
                  ...
                  {(a.entryFeeDisplayText || a.entryFeeInternational != null) && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Entry</span>
                      <span className="font-sans text-[14px] text-cream/88 text-right">
                  ...
                  {a.bestTimeToVisit && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Best Time</span>
                      <span className="font-sans text-[14px] text-cream/88 text-right">{a.bestTimeToVisit}</span>
                    </div>
                  )}
                  {a.timeNeeded != null && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Time Needed</span>
                  ...
                  {a.difficultyAccessLevel && (
                    <div className="flex items-start justify-between gap-3 py-3 border-b border-cream/10">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">Access</span>
                      <span className="font-sans text-[14px] text-cream/88 text-right">{a.difficultyAccessLevel}</span>
                    </div>
                  )}
                  {a.unescoStatus && (
                    <div className="flex items-start justify-between gap-3 pt-3">
                      <span className="font-inter text-[14px] uppercase tracking-[0.12em] text-cream/60 mt-0.5 shrink-0">UNESCO</span>
                    ...
                    <CollapsibleSection title="How to Get There">
                      ...
                      {a.addressDirections && (
                        <div className="bg-sand dark-flip-surf rounded-2xl p-5 border border-line dark-flip-border">
                          <p className="font-inter text-[14px] uppercase tracking-[0.18em] text-charcoal/55 dark-flip-muted mb-2">Address</p>
                      ...
                      {a.entryFeeDisplayText ? (
                        ...
                        <div className="flex gap-8">
                          {a.entryFeeInternational != null && (
                            <div>
                              <p className="font-inter text-[14px] uppercase tracking-[0.16em] text-charcoal/55 dark-flip-muted mb-1">International</p>
                          ...
                          {a.entryFeeLocal != null && (
                            <div>
                              <p className="font-inter text-[14px] uppercase tracking-[0.16em] text-charcoal/55 dark-flip-muted mb-1">Local / Resident</p>
                              <p className="font-display font-bold text-4xl text-charcoal dark-flip-text" style={{ letterSpacing: '-0.02em' }}>
              ...
              {a.experienceTags && a.experienceTags.length > 0 && (
                <div className="mt-10 pt-6 border-t border-line dark-flip-border">
                  <p className="font-inter text-[14px] uppercase tracking-[0.18em] text-charcoal/55 dark-flip-muted mb-4">Tagged</p>
                  <div className="flex flex-wrap gap-2">
                    {a.experienceTags.map(tag => (
                      <span
                        key={tag}
                        className="bg-sand dark-flip-surf text-charcoal/60 dark-flip-muted text-[14px] font-inter px-3 py-1.5 rounded-full border border-line dark-flip-border"
                      >
                        {tag}
                      </span>
                    ))}
              ...
              {a.lastVerifiedDate && (
                <p className="mt-8 font-inter text-[14px] uppercase tracking-[0.16em] text-charcoal/50 dark-flip-muted">
            ...
            <div className="lg:sticky lg:top-24 space-y-5">
              ...
              {(a.nearestAirportIATA || a.addressDirections || a.googleMapsPlaceId) && (
                <div className="bg-sand dark-flip-surf border border-line dark-flip-border rounded-3xl p-6">
                  <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-charcoal/55 dark-flip-muted mb-5">Getting There</p>
                  <div className="space-y-4">
                    {a.nearestAirportIATA && (
                    ...
                    {a.googleMapsPlaceId && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 font-inter text-[14px] uppercase tracking-[0.14em] text-crimson hover:text-crimson/70 transition-colors mt-1"
                      >
                        View on Google Maps
              ...
              <div className="border border-line dark-flip-border rounded-3xl p-6">
                <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-charcoal/55 dark-flip-muted mb-3">Plan Your Visit</p>
              ...
              {a.suitableFor && a.suitableFor.length > 0 && (
                <div className="border border-line dark-flip-border rounded-3xl p-6">
                  <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-charcoal/55 dark-flip-muted mb-4">Suitable For</p>
                  <div className="flex flex-wrap gap-2">
                    {a.suitableFor.map(s => (
              ...
              {a.featuredIn && a.featuredIn.length > 0 && (
                <div className="border border-line dark-flip-border rounded-3xl p-6">
                  <p className="font-inter text-[14px] uppercase tracking-[0.2em] text-charcoal/55 dark-flip-muted mb-4">Featured In</p>
              ...
              {a.country && (
                ...
                >
                  <div>
                    <p className="font-inter text-[14px] uppercase tracking-[0.18em] text-charcoal/55 dark-flip-muted mb-1">Explore more</p>
              ...
              <a
                ...
                className="flex items-center gap-2 justify-center font-inter text-[14px] uppercase tracking-[0.14em] text-charcoal/55 dark-flip-muted hover:text-charcoal/70 transition-colors py-2"
              >
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {faqItems.length > 0 && (
        <div className="bg-sand dark-flip-surf border-t border-line dark-flip-border">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-14 md:py-20">
            <p className="font-inter text-[14px] uppercase tracking-[0.22em] text-charcoal/55 dark-flip-muted mb-3">
              Common Questions
            </p>
            <h2
        ...
        <div className="bg-cream dark-flip-bg border-t border-line dark-flip-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 lg:py-20">
            <div className="flex items-end justify-between mb-8 gap-4">
              <div>
                <p className="font-inter text-[14px] uppercase tracking-[0.22em] text-crimson mb-2">Keep Exploring</p>
              ...
              <Link href={`/destinations/${a.country.slug}`}
                className="inline-link link-arrow hidden sm:inline-flex font-inter text-[14px] uppercase tracking-[0.16em] text-charcoal/55 dark-flip-muted hover:text-crimson transition-colors shrink-0">
                ...
                return (
                  <Link key={rel.slug} href={`/attractions/${rel.slug}`}
                    ...
                    <div className="relative h-40 overflow-hidden bg-sand">
                      ...
                      />
                      {typeLabel && (
                        <span className="absolute top-2 left-2 bg-ink/75 backdrop-blur font-inter text-[14px] uppercase tracking-[0.13em] text-cream/85 px-2.5 py-0.5 rounded-full">
                          {typeLabel}
                        </span>
                      )}
                    </div>
                    <div className="p-4">
                      ...
                      <p className="mt-3 font-inter text-[14px] uppercase tracking-[0.12em] text-crimson group-hover:text-crimson/70 transition-colors">
                        Read guide &#8594;
                      </p>
                    </div>
                  </Link>
