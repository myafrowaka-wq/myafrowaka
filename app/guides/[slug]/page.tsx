  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden min-h-[380px] flex items-end">
        <Image
          src={stockImage('1542729841-c5af4aed2152')}
          alt={guide.title}
          fill priority
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full pb-12 pt-24">
          {guide.focusKeyword && (
            <p className="font-sans text-[14px] uppercase tracking-[0.22em] text-gold-400 mb-3">
              {guide.focusKeyword}
            </p>
          )}
          ...
          <div className="grid lg:grid-cols-3 gap-10 lg:gap-14 items-start">
                  ...
                  return (
                    <div key={a._id}
                      ...
                      <div className="p-6 sm:p-7 flex gap-5 sm:gap-7 items-start">
                        ...
                        {/* Number */}
                        <span
                          className="font-sans font-bold text-[28px] sm:text-[36px] leading-none shrink-0 mt-0.5"
            ...
            <div className="lg:sticky lg:top-24 space-y-5">
              ...
              <div className="bg-ink rounded-3xl p-6 text-cream">
                <p className="font-sans text-[14px] uppercase tracking-[0.2em] text-gold-400/70 mb-3">About this guide</p>
                {guide.focusKeyword && (
