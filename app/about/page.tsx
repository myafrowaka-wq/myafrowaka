    ...
    <>
      ...
      <div className="relative overflow-hidden min-h-[520px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full py-24 sm:py-32">
          <p className="font-sans text-[14px] uppercase tracking-[0.22em] text-gold-400 mb-5">About MyAfroWaka</p>
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-24 space-y-6">
            ...
            <div className="bg-ink rounded-3xl p-7 text-cream">
              <p className="font-sans text-[14px] uppercase tracking-[0.2em] text-gold-400 mb-3">Say Hello</p>
              ...
              <a href="mailto:info@myafrowaka.com"
                className="flex items-center gap-2 font-sans text-[14px] uppercase tracking-[0.14em] text-gold-400 hover:text-gold-300 transition-colors mb-2">
                info@myafrowaka.com
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3">
                    <span className="font-sans text-[14px] text-gold-text dark:text-gold-400 mt-0.5 shrink-0">0{i + 1}</span>
