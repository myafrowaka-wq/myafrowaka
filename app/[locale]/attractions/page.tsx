...
// real bug, found by crawling every link the site renders: every slug
// below was stale/guessed against the real attraction dataset, so this
// fallback (rendered whenever the live attractions query comes back
// empty — a real path, not dead code) 404'd on every single card. Fixed
// against the live dataset: 8 entries corrected to their real, Published
// slug; Djemaa el-Fna, Volcanoes National Park, Cape Point, and Maasai
// Mara National Reserve removed outright rather than left pointing at a
// slug — each exists in Sanity only as Draft, so there is no published
// page to correct the link to yet.
const FALLBACK_ATTRACTIONS: AttractionSummary[] = [
  { name: 'Pyramids of Giza',                 slug: 'pyramids-of-giza-egypt',                          type: ['UNESCO World Heritage Site'],  country: { name: 'Egypt', slug: 'egypt', countryCode: 'eg' }, city: { name: 'Cairo' },          editorialSummary: 'Three structures built over four thousand years ago that remain among the most astonishing on earth.' },
  { name: 'Serengeti National Park',           slug: 'serengeti-national-park-tanzania',                type: ['National Park'],               country: { name: 'Tanzania', slug: 'tanzania', countryCode: 'tz' }, city: { name: 'Arusha Region' },  editorialSummary: 'The annual wildebeest migration through the Serengeti is the largest mammal movement on earth.' },
  { name: 'Victoria Falls',                    slug: 'victoria-falls-zimbabwe',                         type: ['Natural Wonder'],              country: { name: 'Zimbabwe', slug: 'zimbabwe', countryCode: 'zw' }, city: { name: 'Victoria Falls' }, editorialSummary: 'One of the largest curtains of falling water on earth, audible from two kilometres away.' },
  { name: 'Bwindi Impenetrable Forest',        slug: 'bwindi-impenetrable-forest-uganda',               type: ['National Park'],               country: { name: 'Uganda', slug: 'uganda', countryCode: 'ug' }, city: { name: 'Kigezi Region' },  editorialSummary: "Home to roughly half the world's remaining mountain gorilla population." },
  { name: 'Sossusvlei and Deadvlei',          slug: 'sossusvlei-and-deadvlei-namibia',                 type: ['Natural Wonder'],              country: { name: 'Namibia', slug: 'namibia', countryCode: 'na' }, city: { name: 'Namib-Naukluft' }, editorialSummary: 'The tallest dunes in the world change colour across a spectrum that has no adequate name in English.' },
  { name: 'Lalibela Rock-Hewn Churches',       slug: 'lalibela-rock-hewn-churches-ethiopia-att-0103',   type: ['UNESCO World Heritage Site'],  country: { name: 'Ethiopia', slug: 'ethiopia', countryCode: 'et' }, city: { name: 'Lalibela' },       editorialSummary: 'Eleven monolithic churches carved directly from the rock in the twelfth century and still used for active worship.' },
  { name: 'Stone Town Zanzibar',              slug: 'stone-town-zanzibar-tanzania',                    type: ['UNESCO World Heritage Site'],  country: { name: 'Tanzania', slug: 'tanzania', countryCode: 'tz' }, city: { name: 'Zanzibar' },       editorialSummary: 'Six centuries of Swahili, Arab, Indian, and British influence compressed into one navigable old town.' },
  { name: 'Ngorongoro Crater',                slug: 'ngorongoro-crater-tanzania',                      type: ['UNESCO World Heritage Site'],  country: { name: 'Tanzania', slug: 'tanzania', countryCode: 'tz' }, city: { name: 'Ngorongoro' },     editorialSummary: "The world's largest intact volcanic caldera contains one of the densest concentrations of wildlife in Africa." },
]
