      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-0 min-h-[580px]">
          <div className="py-20 lg:py-28 pr-0 lg:pr-20 flex flex-col justify-center">
            ...
            <p className="font-inter text-[9px] uppercase tracking-[0.24em] text-gold-400/70 mb-5">{slide.tag}</p>
            ...
            <div className="flex flex-wrap gap-3 mb-12">
              <Link href={`/blog/${slide.slug}`}
                className="inline-flex items-center gap-2 bg-crimson hover:bg-crimson-600 text-cream font-inter text-[11px] uppercase tracking-[0.13em] px-6 py-3.5 rounded-full transition-all btn-magnetic">
              ...
              <Link href={`/destinations/${slide.tagSlug}`}
                className="inline-flex items-center border border-white/20 hover:border-white/40 text-cream/70 hover:text-cream font-inter text-[11px] uppercase tracking-[0.13em] px-6 py-3.5 rounded-full transition-colors">
                Explore {slide.tag}
              </Link>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="font-inter text-[10px] text-cream/22 tabular-nums ml-1">
