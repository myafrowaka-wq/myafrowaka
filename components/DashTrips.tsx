      ...
      {trips.map(trip => (
        <div key={trip._id}
          ...
          <div className="bg-ink px-5 py-4">
            <p className="font-inter text-[7px] uppercase tracking-[0.2em] text-gold-400/60 mb-1">Planned Trip</p>
          ...
          <div className="p-5 space-y-2.5">
            {(trip.dates?.from || trip.dates?.to) && (
              <div className="flex items-start gap-2.5">
                ...
                <span className="font-sans text-[12px] text-charcoal/55 dark-flip-muted">
            ...
            {trip.interests && trip.interests.length > 0 && (
              <div className="flex flex-wrap gap-1.5 pt-1">
                {trip.interests.map(i => (
                  <span key={i} className="font-inter text-[7px] uppercase tracking-[0.12em] bg-gold-50 dark:bg-gold-900/20 text-gold-700 dark:text-gold-400 px-2 py-0.5 rounded-full">
                    {i}
                  </span>
                ))}
              </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-line dark-flip-border mt-3">
              ...
              <button
                ...
                className="font-inter text-[9px] uppercase tracking-[0.12em] text-charcoal/30 hover:text-crimson transition-colors disabled:opacity-40">
