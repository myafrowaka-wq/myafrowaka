      ...
      <div className="flex flex-wrap gap-1.5">
        {STATUS_TABS.map(tab => (
          <button
            ...
            className={`flex items-center gap-1.5 font-sans text-[14px] uppercase tracking-[0.12em] px-3.5 py-2 rounded-full border transition-all ${
              activeTab === tab
                          ...
                          <>
                            ...
                            {(a.contentStatus === 'Draft' || a.contentStatus === 'Incomplete') && (
                              <button onClick={() => changeStatus(a._id, 'Verified')}
                                className="font-sans text-[14px] uppercase tracking-[0.1em] text-moss-700 hover:text-moss-600 border border-moss-200 hover:border-moss-400 px-2.5 py-1 rounded-lg transition-all whitespace-nowrap">
                                Submit
                              </button>
                            )}
