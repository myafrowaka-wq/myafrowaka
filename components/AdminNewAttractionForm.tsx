...
export function AdminNewAttractionForm() {
  ...
  if (status === 'success') {
    return (
      <div className="rounded-2xl bg-moss/8 border border-moss/20 p-8 text-center">
        ...
        {attrSlug && (
          <p className="font-inter text-[14px] text-charcoal/30 dark-flip-muted mt-4">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          <label className="font-display font-semibold text-[14px] uppercase tracking-[0.1em] text-charcoal/50 dark-flip-muted block mb-2">Region</label>
        ...
        <div>
          <label className="font-display font-semibold text-[14px] uppercase tracking-[0.1em] text-charcoal/50 dark-flip-muted block mb-2">Type</label>
          <div className="relative">
