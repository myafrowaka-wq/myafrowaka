    ...
    <div className="flex flex-wrap gap-2">
      {displayed.map(p => (
        <Link
          ...
          className="inline-flex items-center gap-1 bg-white/8 hover:bg-white/15 border border-white/10 hover:border-white/22 text-cream/60 hover:text-cream/85 font-inter text-[14px] uppercase tracking-[0.10em] px-3 py-1.5 rounded-full transition-all"
        >
